...
<body>
    <div class="d-flex justify-content-center flex-column align-items-center">
        ...
        <a href="../sys/logout.php" class="btn btn-danger mt-3">Logout <i class="fa fa-right-from-bracket"></i></a>
        <form action="../sys/createToDo.php" method="POST">
            <input type="text" name="todo" placeholder=" Type Your To Do Here" class="rounded py-2 mt-3" style="width: 300px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex gap-2">
                        ...
                        <i class="fa fa-solid fa-pencil"></i> Ubah Cuy
                        </button>
                        <form action="../sys/deleteToDo.php" method="POST">
                            <input type="hidden" name="id" value="<?= $todo['id']?>">
                            <button type="submit" class="btn btn-danger"><i class="fa fa-solid fa-trash"></i> DAH KELAR</button>
                        </form>
                    </td>
                </tr>
                <?php endforeach?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form action="../sys/editToDo.php" method="POST">
                ...
                <input type="text" name="todo" placeholder=" Type Your To Do Here" class="rounded py-2 mt-3" style="width: 300px;" id="todo">
